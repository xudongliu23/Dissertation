...
the \tit{at-most} relation $\leq$ over $\bbN$ is reflexive,
...
We consider attributes such as \tit{Price}, \tit{Safety}, and \tit{Capacity}.
...
For instance, vector $\rangle$ \tit{med,high,7m} $\langle$ represents
...
A \tit{formulas} is either a truth symbol, a variable, or, if $\varphi$ and $\psi$ are formulas,
