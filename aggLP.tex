...
for $k$-approval \tblref{kApp_comp}, $b$-Borda \tblref{bBorda_comp} and 
$(k,l)$-approval \tblref{klApp_comp} rules.
The results for $2^{p-1}$-approval, as well as those in \tblref{kApp_comp_b}
and \tblref{bBorda_comp_a} are attributed to Lang et al. \cite{lang:aggLP}.
\begin{table}
	\centering
