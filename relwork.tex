...
Attribute \tit{Capacity} ($X_1$) has two values \tit{high} ($1_1$) 
and \tit{low} ($0_1$).
Attribute \tit{Price} ($X_2$) has two values \tit{high} ($1_2$) 
and \tit{low} ($0_2$).
Attribute \tit{Safety} ($X_3$) has two values \tit{high} ($1_3$) 
and \tit{low} ($0_3$).
	    ...
	    \node [main node] (1){$X_1$}
	      child {node [main node] (2) {$X_2$}
	      	child {node [main node] (3) {$X_3$} {}
							...
							child {node [rectangle split, rectangle split parts=2,draw] (5) at (1.7,2.8)
								{$1_1:1_2>0_2$ \nodepart{second} $0_1:0_2>1_2$} edge from parent[draw=none]}
							child {node [rectangle split, rectangle split parts=2,draw] (6) at (1.05,1.4) 
  ...
  \begin{subfigure}[b]{0.45\textwidth}
		\centering
		  \begin{tikzpicture}[->,>=stealth',node distance=1cm,main node/.style={circle,draw,font=\small}]
		    \node[rectangle,inner sep=0pt] (1)                                         {$0_11_20_3$};
				\node[rectangle,inner sep=0pt] (2) [below of=1]                            {$0_11_21_3$};
				\node[rectangle,inner sep=0pt] (3) [below of=2]                            {$0_10_21_3$};
				\node[rectangle,inner sep=0pt] (4) [left of =3,xshift=-1cm,yshift=-0.5cm]  {$0_10_20_3$};
				\node[rectangle,inner sep=0pt] (5) [below of=3]                            {$1_10_21_3$};
				\node[rectangle,inner sep=0pt] (6) [left of=5,xshift=-1cm,yshift=-0.5cm]   {$1_10_20_3$};
				\node[rectangle,inner sep=0pt] (7) [below of=6]                            {$1_11_20_3$};
				\node[rectangle,inner sep=0pt] (8) [below of=5,yshift=-1cm]                {$1_11_21_3$};
...
CPN-OPTIMALITY-\rom{3}) are easy, that is, they are
...
\begin{figure}
  \small
	...
	\begin{tikzpicture}[->,>=stealth',
	  ...
	  \node [main node,inner sep=4pt] (1){$X_1$}
	    child {node [main node,inner sep=4pt] (2) {$X_3$}
	      child {node [main node,inner sep=4pt] (3) {$X_2$}}
	      child {node [main node,inner sep=4pt] (4) {$X_2$}
					child {node [rectangle,draw] at (6.3,4.5) {$1_1>0_1$} edge from parent[draw=none]}
					child {node [rectangle,draw] at (0.35,3) {$1_3>0_3$} edge from parent[draw=none]}
					child {node [rectangle,draw] at (-0.7,0.6) {$1_2>0_2$} edge from parent[draw=none]}
					child {node [rectangle,draw] at (0,0.6) {$0_2>1_2$} edge from parent[draw=none]}
					child {node [rectangle,draw] at (2.95,3) {$0_2>1_2$} edge from parent[draw=none]}
					child {node [rectangle,draw] at (-0.5,0.6) {$1_3>0_3$} edge from parent[draw=none]}
					child {node [rectangle,draw] at (0,0.6) {$1_3>0_3$} edge from parent[draw=none]}
				}
	    }
	    child {node [main node,inner sep=4pt] (5) {$X_2$}
	    child {node [main node,inner sep=4pt] (6) {$X_3$}}
	      child {node [main node,inner sep=4pt] (7) {$X_3$}}
	    };
	    \path[every node/.style={font=\sffamily\small}]
	      (1) edge (2)
	          edge (5)
...
\begin{figure}
  ...
  \begin{tikzpicture}[->,>=stealth',node distance=2cm,main node/.style={circle,draw,font=\small}]
    ...
    \node[main node,inner sep=4pt] (1) {$X_1$};
    \node[rectangle,draw] at (1.3,0) {$1_1>0_1$};
    
    \node[main node,inner sep=4pt] (2) [below left of=1] {$X_3$};
    \node[rectangle,draw] at (-2.7,-1.4) {$1_3>0_3$};
		%\node[rectangle] at (-2.0,-1.4) {$t'$};
    
    \node[main node,inner sep=4pt] (3) [below of=2] {$X_2$};
    \node[rectangle split, rectangle split parts=2, draw, font=\sffamily\small] at (-3,-3.5)
        {
          $1_3:1_2>0_2$
          \nodepart{second}
          $0_3:0_2>1_2$
    ...
    \node[main node,inner sep=4pt] (4) [below right of=1] {$X_2$};
    \node[rectangle,draw] at (2.7,-1.4) {$0_2>1_2$};
    
    \node[main node,inner sep=4pt] (5) [below of=4] {$X_3$};
    \node[rectangle,draw] at (2.7,-3.4) {$1_3>0_3$};
...
By associating the root of $\PT$ with $\CD(\cA)$,
...
\begin{figure}[!ht]
  \centering
    \begin{tikzpicture}[->,>=stealth',
      level/.style={sibling distance=2cm/#1, level distance=38pt}]
      \node [main node,inner sep=0pt] (1){$X_1\!\! \lor \!\! X_2$}
        child {node [main node,inner sep=6pt] (2) {$X_1$}
        }
        child {node [main node,inner sep=6pt] (5) {$X_3$}
        };
    \end{tikzpicture}
...
We look at the preference tree in \figref{fpt}.
...
PT-OPTIMALITY-\rom{2} is coNP-complete,
and PT-OPTIMALITY-\rom{3} is $\deltap{2}$-complete.
...
the propostional formulas $C_i$. As mentioned in the work by Brewka et al \cite{Brewka03answerset},
