...
%}
%% end of comments
Preferences are ubiquitous in various forms (e.g.,
...
Preferences can be represented in a \tit{quantitative} or \tit{qualitative} manner.
...
\tit{partial lexicographic preference trees} (PLP-trees)\cite{conf/aaai15/LiuT} and
\tit{preference trees} (P-trees)\cite{liu2014preference,conf/adt15/liuT}.
